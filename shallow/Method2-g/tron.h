...
{
public:
	TRON(const function *fun_obj, double eps = 0.1, int max_cg_iter = 10, int num_sample = 20, int max_iter = 100, double my_c = 1.0, int solver_type = 0);
	~TRON();

	void tron(double *w, const char *test_file);
