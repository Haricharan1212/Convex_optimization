...
TRON::TRON(const function *fun_obj, double eps, int max_cg_iter, int num_sample, int max_iter, double my_c)
{
...
void TRON::tron(double *w, const char *test_file)
{
	...
	double shift_time = 0.0, cg_time = 0.0, line_search_time = 0.0;
